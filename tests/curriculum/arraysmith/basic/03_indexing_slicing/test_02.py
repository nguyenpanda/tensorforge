...
_INDICES: np.ndarray = np.array([7, 0, 15, 3, 7, 99, 42, 128, 0, 199], dtype=np.int64)
...
class TestIndexingSlicing:
    ...
    def test_filter_above_threshold(self, benchmark_config):
        ...
        compare_and_benchmark(
            ...
            baseline_fn=lambda: IndexingSlicingBaseline.filter_above_threshold(arr, _THRESHOLD),
    ...
    def test_gather_by_indices(self, benchmark_config):
        ...
        compare_and_benchmark(
            ...
            baseline_fn=lambda: IndexingSlicingBaseline.gather_by_indices(arr, indices),
            config=benchmark_config,
        )
